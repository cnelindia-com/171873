...
const Overview = ({
  ...
  return (
    <SectionContainer>
      ...
      <NursingHomeHeader>
        <WelcomeTitle>
         {t("ad-dashboard.welcome", {
            name: userName || t("ad-dashboard.default_name"),
          })}
        </WelcomeTitle>
      </NursingHomeHeader>
      ...
      <StatsContainer>
        <StatCard>
          <StatNumber variant="primary">{totalSpots}</StatNumber>
          <StatLabel>{t("ad-dashboard.stats.active_places")}</StatLabel>
        </StatCard>

        <StatCard>
          <StatNumber>{totalInquiries}</StatNumber>
          <StatLabel>{t("ad-dashboard.stats.total_inquiries")}</StatLabel>
        </StatCard>

        <StatCard>
          <StatNumber>{monthlyInquiries}</StatNumber>
          <StatLabel>{t("ad-dashboard.stats.this_month")}</StatLabel>
        </StatCard>
      </StatsContainer>
      ...
      <ActionsRow>
        <ActionButton onClick={() => navigate("/dashboard/places/new")}>
          {t("ad-dashboard.actions.add_place")}
        </ActionButton>

        <ActionButton onClick={() => navigate("/dashboard/subscription")}>
          {t("ad-dashboard.actions.manage_subscription")}
        </ActionButton>
      </ActionsRow>
